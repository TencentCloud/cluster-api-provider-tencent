...
func (client *Client) Invoketest(action string, args interface{}, response interface{}) string {
	//switch client.opts.Method {
	//case "GET":
	str := client.InvokeWithGETtest(action, args, response)
	return str
	//default:
	//	_,str := client.InvokeWithPOST(action, args, response)
	//	return str
	//}
}

func (client *Client) InvokeWithGETtest(action string, args interface{}, response interface{}) string {
	...
	for k, v := range credValues {   //creditid,signature
		reqValues.Set(k, v)
	}
	...
	//reqValues.Set("Version",cvm.DefaultVersion)
...
func (client *Client) InvokeClusterInstance(action string, args interface{}, response interface{}) (error,string) {
	switch client.opts.Method {
	case "GET":
		return client.InvokeWithGETCluster(action, args, response)
	default:
		return nil,""
	}
}

func (client *Client) InvokeClusterInstanceTest(action string, args interface{}, response interface{}) string {
	str := client.InvokeWithGETClusterTest(action, args, response)
	return str
}

func (client *Client) InvokeWithGETCluster(action string, args interface{}, response interface{}) (error,string) {
	reqValues := url.Values{}
...
func (client *Client) InvokeWithGETClusterTest(action string, args interface{}, response interface{}) string {
	reqValues := url.Values{}
